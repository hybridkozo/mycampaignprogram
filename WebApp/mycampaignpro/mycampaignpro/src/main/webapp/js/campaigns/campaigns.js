                                 ...
                                 if (data!==null){
                                     for (i=0;i<flen;i++){
                                      ...
                                      if(data[i][2]==="INACTIVE"){
                                          x+='<td>' + '<button type="button" class="btn btn-outline-dark" onclick="edit.showEditState(' + data[i][0] +')">Edit</button><button type="button" class="btn btn-outline-primary" onclick="campaign.activate(' + data[i][0] +')">Activate</button><button type="button" class="btn btn-outline-dark" onclick="campaign.showDetails(' + data[i][0] +')">Details</button></td></tr>';
                                      }else{
...
var edit = {
  ...
  showEditState: function(id){
        sessionStorage.setItem("campaignid",id);
        window.location.replace("/simplenotificationedit.html");
    },
    writeEditData: function(){
